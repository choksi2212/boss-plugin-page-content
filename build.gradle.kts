...
// 0.1.0: structured page content (text, headings, links, screenshot) for BOSS plugins and
// agents. Exposes a new PageContentProvider plugin API plus page_content_* MCP tools.
version = "0.1.2"
...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-page-content-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Page Content Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.pagecontent.PageContentDynamicPlugin",
        )
    }
